...
def build_dashboard_context(user, user_id):
    ...
    for i in range(7):
        ...
        daily_count = count_completed_responses(DailyResponse, user_id, day_start_ts, day_end_ts)
        event_count = count_completed_responses(EventResponse, user_id, day_start_ts, day_end_ts)
    ...
    daily_completed_today = count_completed_responses(
